...
class SnackTests(TestCase):
    def setUp(self):
        ...
        self.snack = Snack.objects.create(title="pickle", purchaser=self.user, description="pickle description")
    ...
    def test_snack_content(self):
        ...
        self.assertEqual(f"{self.snack.description}", "pickle description")
    ...
    def test_model(self):
        snack = Snack.objects.create(title="pickle", purchaser=self.user)
